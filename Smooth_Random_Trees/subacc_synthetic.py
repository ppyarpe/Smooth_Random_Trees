...
train = pd.read_csv('/Users/anaritapena/Smooth_Random_Trees/Smooth_Random_Trees/Synthetic Datasets/train.csv',index_col=False)

test.columns=['default','gender','salary']
train.columns=['default','gender','salary']
...
for covar in covar_list:
    ...
    test_acc['salary'] = pd.cut(test_acc['salary'], bins=range(0,63000,6300), labels=[f'{l}-{l+6300}' for l in range(0,56700,6300)])
...
# #ax = sns.countplot(x="age", data=test_acc)
    ...
    plt.tight_layout()
    plt.savefig('/Users/anaritapena/Smooth_Random_Trees/Smooth_Random_Trees/Synthetic Datasets/'+str(covar)+'_line_plot.png')
...
plt.savefig('/Users/anaritapena/Smooth_Random_Trees/Smooth_Random_Trees/Synthetic Datasets/dataset_pairplot.png')
