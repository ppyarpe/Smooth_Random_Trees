...
output_path='NP_RandomForest/testing_6v/'+str(n_trees)+'_trees/y_pred.csv'
...
perfy.to_csv('NP_RandomForest/testing_6v/'+str(n_trees)+'_trees/performance_metrics.csv',index=None)
