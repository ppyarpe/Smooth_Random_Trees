...
for total_budget in total_budgets_list:
    ...
    output_path='testing_3v/'+str(ntree)+'_trees/NP/y_pred_full_budget_'+str(total_budget)+'.csv'
...
perfy.to_csv('testing_3v/'+str(ntree)+'_trees/NP/performance_metrics_'+str(total_budget)+'.csv')
